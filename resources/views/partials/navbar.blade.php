    ...
    <div class="max-w-7xl mx-auto px-6 py-4">
        <div class="flex justify-between items-center">
            ...
            <nav class="space-x-6 hidden md:flex" role="navigation" aria-label="Main navigation">
                <a href="{{ url('/') }}" class="text-gray-700 hover:text-seova-orange font-medium" aria-current="@if(request()->is('/')) page @endif">Home</a>
                <a href="{{ url('/') }}#services" class="text-gray-700 hover:text-seova-orange font-medium">Services</a>
                <div class="relative">
                    <button id="toolsToggle" class="text-gray-700 hover:text-seova-orange font-medium focus:outline-none focus:ring-2 focus:ring-seova-orange focus:ring-offset-2 rounded" aria-expanded="false" aria-haspopup="true" aria-label="Open tools menu">
                        Tools 
            ...
            <!-- Desktop CTA Button -->
            <a href="{{ url('/') }}#contact" class="bg-seova-green text-white px-4 py-2 rounded-md font-semibold hover:bg-blue-700 transition hidden md:block" aria-label="Get a free SEO quote from Seova">Get a Free Quote</a>
            
            <!-- Mobile Menu Button -->
            <button id="mobileMenuToggle" class="md:hidden text-gray-700 hover:text-seova-orange focus:outline-none focus:ring-2 focus:ring-seova-orange focus:ring-offset-2 rounded" aria-expanded="false" aria-controls="mobileMenu" aria-label="Open mobile menu">
        ...
        <div id="mobileMenu" class="hidden md:hidden mt-4 pb-4 border-t border-gray-200" role="navigation" aria-label="Mobile navigation">
            <nav class="flex flex-col space-y-3 mt-4">
                <a href="{{ url('/') }}" class="text-gray-700 hover:text-seova-orange font-medium py-2" aria-current="@if(request()->is('/')) page @endif">Home</a>
                <a href="#services" class="text-gray-700 hover:text-seova-orange font-medium py-2">Services</a>
                <div class="py-2">
                    <button id="mobileToolsToggle" class="text-gray-700 hover:text-seova-orange font-medium focus:outline-none focus:ring-2 focus:ring-seova-orange focus:ring-offset-2 rounded w-full text-left" aria-expanded="false" aria-controls="mobileToolsMenu" aria-label="Open mobile tools menu">
                        Tools 
                        <span aria-hidden="true">▼</span>
                    </button>
